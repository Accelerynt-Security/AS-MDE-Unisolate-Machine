...
Enter "**AS-MDE-Unisolate-Machine**" for the name, all else can be left as is. Click "**Register**"
...
Choose a name for the secret, such as "**AS-MDE-Unisolate-Machine-AR-Client-Secret**", and enter the client secret copied in the [previous section](https://github.com/Accelerynt-Security/AS-MDE-Unisolate-Machine#create-an-app-registration). All other settings can be left as is. Click "**Create**". 
